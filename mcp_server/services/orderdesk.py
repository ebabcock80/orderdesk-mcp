...
class OrderDeskService:
    ...
    async def _get_store_credentials(self, tenant_id: str, store_id: str) -> dict[str, str] | None:
    ...
    async def list_orders_direct(self, store_id: str, api_key: str, limit: int = 50, offset: int = 0, status: str | None = None, folder_id: int | None = None) -> dict[str, Any]:
    ...
    async def list_products_direct(self, store_id: str, api_key: str, search: str | None = None, limit: int = 50, offset: int = 0) -> dict[str, Any]:
    ...
    async def list_customers_direct(self, store_id: str, api_key: str, search: str | None = None, limit: int = 50, offset: int = 0) -> dict[str, Any]:
    ...
    async def create_folder_direct(self, store_id: str, api_key: str, name: str, description: str | None = None) -> dict[str, Any]:
    ...
    async def create_webhook_direct(self, store_id: str, api_key: str, url: str, events: list[str], secret: str | None = None) -> dict[str, Any]:
    ...
    async def get_reports_direct(self, store_id: str, api_key: str, report_type: str, start_date: str | None = None, end_date: str | None = None) -> dict[str, Any]:
